...
public:
    ...
    sf::Joystick::Axis servoZAxis();
    bool isServoZInvese();
    void setServoZAxis(sf::Joystick::Axis axis, bool inverse);
    ...
    int stopButton();
    void setStopButton(int button);

    int fiftyButton();
    void setFiftyButton(int button);

    int twentyFiveButton();
    void setTwentyFiveButton(int button);
...
private:
    ...
    QScopedPointer<QComboBox> m_stopButtonList;
    ...
    QScopedPointer<QCheckBox> m_servoZInv;
